      ...
      <div className="relative aspect-video bg-black rounded-lg overflow-hidden">
        {host1VideoTrack && host1VideoTrack.publication ? (
          ...
          <div className="absolute inset-0 flex flex-col items-center justify-center text-white">
            ...
            <p className="text-sm text-white/70">Host 1 offline</p>
          </div>
        )}
      </div>
      ...
      <div className="relative aspect-video bg-black rounded-lg overflow-hidden">
        {host2VideoTrack && host2VideoTrack.publication ? (
          ...
          <div className="absolute inset-0 flex flex-col items-center justify-center text-white">
            ...
            <p className="text-sm text-white/70">Host 2 offline</p>
          </div>
        )}
      </div>
    </div>
...
export function DualHostViewer({
  sessionId,
  sessionTitle,
}: DualHostViewerProps) {
